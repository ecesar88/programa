...
export const Orders = memo(function ClientsComponent(): React.ReactNode {
  ...
  const actions: ScreenMenuProps['actions'] = {
    ...
    onSaveClick: () => {
      const onCreate: SubmitHandler<OrderWithoutId> = (data) => {
        createClientMutation(data)
      }

      const onEdit: SubmitHandler<OrderWithoutId> = (data) => {
