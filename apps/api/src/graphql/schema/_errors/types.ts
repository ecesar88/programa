...
const ZodValidationErrorDetailRef =
	builder.objectRef<ZodValidationErrorDetailType>("ZodValidationErrorDetail");
export const ZodValidationErrorDetailObject =
	ZodValidationErrorDetailRef.implement({
		description:
...
const ZodValidationErrorRef =
	builder.objectRef<ZodValidationErrorType>("ZodValidationError");
