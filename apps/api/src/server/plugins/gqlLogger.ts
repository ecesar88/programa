import type { useLogger } from 'graphql-yoga'
import nodeColorLog from 'node-color-log'
import type { GQLDefinitions } from '../../utils/types/graphqlDocument'
...
const getNamedOperationMetaData = (
  ...
  // biome-ignore lint/style/noNonNullAssertion: controlled unsafe access
...
export const gqlLogger: Parameters<typeof useLogger>['0'] = {
  skipIntrospection: false,
  logFn: (eventName: EventName, args1: { args: any }) => {
