...
import { CreateOrEditModal, Read } from '@renderer/components/pages/Clients'
  ...
  const actions: ScreenMenuProps['actions'] = {
    ...
    onSaveClick: () => {
      const onCreate: SubmitHandler<Client> = (data): void => {
        createClientMutation(data as CreateMenuEntryMutationVariables)
      }
      ...
      const onEdit: SubmitHandler<Client> = (data): void => {
        ...
        editClientMutation({
          id: id!,
          data: data as unknown as ClientCreateOrUpdateInput
        })
      }
