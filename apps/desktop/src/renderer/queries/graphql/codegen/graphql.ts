...
export type GetAllMenuEntryLabelsQuery = { __typename?: 'Query', getAllMenuEntryLabels: Array<{ __typename?: 'MenuEntryLabel', id: number | null, name: string | null, color: string | null }> | null };
